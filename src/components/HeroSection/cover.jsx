...
export const Cover = ({
  ...
  return (
    (<div
      ...
      ref={ref}
      className="relative hover:bg-none  group/cover inline-block bg-none px-2 py-2  transition duration-200 rounded-sm">
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <motion.span
        ...
        className={cn(
          "text-blue-500 font-bold inline-block relative z-20 group-hover/cover:text-blue-500 transition duration-200",
          className
        )}>
        {children}
      </motion.span>
